...
export default function Page() {
  ...
  const handleCountdownUpdate = (value: string) => {
    ...
    if (abs < 60) text = rtf.format(Math.round(diff), "second");
      ...
      text = rtf.format(Math.round(diff / 2592000), "month");
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4">
          ...
          <section className="mt-12 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex-1 rounded-lg p-3 bg-slate-700 text-gray-100 border border-slate-600">
                  <div className="text-sm text-gray-300">
                    Current time in {lookupTz}
                  </div>
                  <div className="font-medium">
                    {safeFormatInZone(new Date(), lookupTz)}
                  </div>
                  <div className="text-sm text-gray-400 mt-1">
                    {timeZoneNameShort(new Date(), lookupTz) || ""}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card">
              ...
              <div className="grid sm:grid-cols-2 gap-3 mb-3">
                ...
                <div>
                  <div className="block text-sm font-medium mb-1 text-slate-200">
                    Zones to compare
                  </div>
              ...
              {compareInput && (
                <div className="grid sm:grid-cols-2 gap-3">
                  {compareZones.map((tz) => (
                    <div
                      key={tz}
                      className="rounded-lg p-3 bg-slate-700 text-gray-100 border border-slate-600"
                    >
                      ...
                      <div className="text-sm text-gray-400 mt-1">
                        {timeZoneNameShort(new Date(compareInput), tz) || ""}
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <section className="mt-12 text-gray-300 leading-relaxed space-y-4">
            ...
            <p>
              ...
              timezone. For example, writing{" "}
              <code>&lt;t:1739059200:F&gt;</code> shows a localized date like{" "}
              <em>Sunday, February 9, 2025 10:00 AM</em> depending on who views
              it.
            </p>
            <p>
              There are seven formats: <code>t</code>, <code>T</code>,{" "}
              <code>d</code>,<code>D</code>, <code>f</code>, <code>F</code>, and{" "}
              <code>R</code> (relative). Use the presets above to quickly generate
              the right one for your message.
            </p>
            <h3 className="text-lg font-semibold text-gray-100">
              Unix Time & DST
            </h3>
            <p>
              Unix time (epoch) counts seconds since Jan 1, 1970 UTC. Time zones
              and daylight saving time (DST) are regional rules that offset from
              UTC. The tools above use your browser’s Intl API to display local
              times correctly per zone.
            </p>
          </section>
